...
class Menu {
  ...
  Menu({Key? key, required this.label, this.items = const [], this.icon, this.onTap, this.keybind, this.hidden = false}) : key = key ?? UniqueKey();
  ...
  List<Menu> get filteredItems => items.where((element) => !element.hidden).toList();
